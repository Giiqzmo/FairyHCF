...
use vale\hcf\HCF;
use vale\hcf\items\inventory\BrewingInventory;
...
class BrewingStand extends Spawnable implements InventoryHolder, Container, Nameable {
	...
	public function isValidMatch(Item $ingredient, Item $potion): bool{
		$recipe = HCF::getInstance()->getBrewingManager()->matchBrewingRecipe($ingredient, $potion);

		return $recipe !== null;
	}

	public function onUpdate(): bool{
		if($this->isClosed() || !HCF::$brewingStandsEnabled){
			return false;
		}
